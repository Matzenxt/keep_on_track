  ...
  static Future<Database> getDB() async {
    return openDatabase(join(await getDatabasesPath(), _dbName),
        onCreate: (db, version) async {
          ...
          await db.execute("CREATE TABLE TimeSlot(id INTEGER NOT NULL UNIQUE PRIMARY KEY AUTOINCREMENT, weekDay INTEGER NOT NULL, startTime TEXT NOT NULL, endTime TEXT NOT NULL, room TEXT NOT NULL, lectureID INTEGER NOT NULL);");
        },
