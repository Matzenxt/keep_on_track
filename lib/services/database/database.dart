  ...
  static Future<Database> getDB() async {
    return openDatabase(join(await getDatabasesPath(), _dbName),
        onCreate: (db, version) async {
          await db.execute("CREATE TABLE Todo(id INTEGER NOT NULL UNIQUE PRIMARY KEY AUTOINCREMENT, done INTEGER NOT NULL DEFAULT 0, title TEXT NOT NULL, note TEXT, alertDate INTEGER DEFAULT NULL, notificationID INTEGER DEFAULT NULL);");
